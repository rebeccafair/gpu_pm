...
.SUFFIXES : .cu .cu_dbg.o .c_dbg.o .cpp_dbg.o .cu_rel.o .c_rel.o .cpp_rel.o .cubin .ptx .cpp.o

OMIT_CUTIL_LIB   := 1

# Add new SM Versions here as devices with new Compute Capability are released
SM_VERSIONS   := 10 11 12 13 20 30 35

CUDA_INSTALL_PATH := /usr/local/cuda-6.5
CUDA6_SAMPLE_PATH := /usr/local/cuda-6.5/samples
GCC_INSTALL_PATH := /usr/local/gcc48/gcc-alt-481/x86_64-slc6-gcc48-opt/bin
...
CXX        := $(GCC_INSTALL_PATH)/g++ -fPIC
CC         := $(GCC_INSTALL_PATH)/gcc -fPIC
LINK       := $(GCC_INSTALL_PATH)/g++ -fPIC

# Includes
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -I$(CUDA6_SAMPLE_PATH)/common/inc
...
#	TARGETDIR := $(LIBDIR)
	...
	ifneq ($(OMIT_CUTIL_LIB),1)
		LIB += -lcutil_$(LIB_ARCH)$(LIBSUFFIX) -lshrutil_$(LIB_ARCH)$(LIBSUFFIX) #-L/data/IDprep/triggerExampleNew/lib
	endif
...
#	$(VERBOSE)$(NVCC) -gencode=arch=compute_$(1),code=\"sm_$(1),compute_$(1)\" $(GENCODE_SM20) -o $$@ -c $$< $(NVCCFLAGS)
	$(VERBOSE)$(NVCC) -gencode=arch=compute_20,code=\"sm_$(1),compute_20\" $(GENCODE_SM20) -o $$@ -c $$< $(NVCCFLAGS)
endef
